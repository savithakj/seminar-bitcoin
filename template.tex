...
bounded by a value both prior defined and publicly known\cite{nakamoto2012bitcoin}.
...
Bitcoin has several important features that set it apart from normal fiat currencies\cite{grinberg2012bitcoin}.
...
%
\bibliographystyle{IEEEtran} %instead of IEEEtran, you can use alpha also
